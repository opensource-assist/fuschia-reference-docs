...
*Defined in [fuchsia.media.drm/content_decryption.fidl](https://fuchsia.googlesource.com/fuchsia/+/master/sdk/fidl/fuchsia.media.drm/content_decryption.fidl#44)*
 ...
 media content. There may be zero to many active <a class='link' href='../fuchsia.media.drm/index.html#LicenseSession'>LicenseSession</a>s
 ...
 * error an <a class='link' href='../fuchsia.media.drm/index.html#Error'>Error</a> indicating the reason for failure.
...
<table>
    ...
    <tr>
            ...
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#ContentDecryptionModule_SetServerCertificate_Result'>ContentDecryptionModule_SetServerCertificate_Result</a></code>
            </td>
        </tr></table>
...
### CreateLicenseSession {:#CreateLicenseSession}
 ...
 The `session_id` will be generated by the <a class='link' href='../fuchsia.media.drm/index.html#ContentDecryptionModule'>ContentDecryptionModule</a>
 ...
 + request `session_type` a field containing either
   <a class='link' href='../fuchsia.media.drm/index.html#LicenseSessionType.TEMPORARY'>LicenseSessionType.TEMPORARY</a>,
   <a class='link' href='../fuchsia.media.drm/index.html#LicenseSessionType.PERSISTENT_LICENSE'>LicenseSessionType.PERSISTENT_LICENSE</a> or
   <a class='link' href='../fuchsia.media.drm/index.html#LicenseSessionType.PERSISTENT_USAGE_RECORD'>LicenseSessionType.PERSISTENT_USAGE_RECORD</a>
 + request `license_session` the server endpoint of the
   <a class='link' href='../fuchsia.media.drm/index.html#LicenseSession'>LicenseSession</a>
...
<table>
    ...
    <tr>
            ...
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#LicenseSessionType'>LicenseSessionType</a></code>
            </td>
        </tr><tr>
            <td><code>license_session</code></td>
            <td>
                <code>request&lt;<a class='link' href='../fuchsia.media.drm/index.html#LicenseSession'>LicenseSession</a>&gt;</code>
            </td>
        </tr></table>
...
### CreateDecryptor {:#CreateDecryptor}
 ...
 the active sessions for this <a class='link' href='../fuchsia.media.drm/index.html#ContentDecryptionModule'>ContentDecryptionModule</a>.
...
<table>
    ...
    <tr>
            ...
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#DecryptorParams'>DecryptorParams</a></code>
            </td>
        </tr><tr>
...
### GetKeyStatusForHdcpVersion {:#GetKeyStatusForHdcpVersion}
 ...
 establishing a <a class='link' href='../fuchsia.media.drm/index.html#LicenseSession'>LicenseSession</a>. For example, if the device would
...
<table>
    ...
    <tr>
            ...
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#KeyStatus'>KeyStatus</a></code>
            </td>
        </tr></table>
...
### OnReady {:#OnReady}
 ...
 Indicates that the <a class='link' href='../fuchsia.media.drm/index.html#LicenseSession'>LicenseSession</a> has successfully initialized.
...
### GenerateLicenseRequest {:#GenerateLicenseRequest}
 ...
 When the <a class='link' href='../fuchsia.media.drm/index.html#LicenseMessage'>LicenseMessage</a> has been created, the
 ...
 + request `init_data` container-specific data that is used to generate a
   <a class='link' href='../fuchsia.media.drm/index.html#LicenseMessageType.REQUEST'>LicenseMessageType.REQUEST</a> `LicenseMessage`.
 * error an <a class='link' href='../fuchsia.media.drm/index.html#Error'>Error</a> indicating the reason for failure.
...
<table>
    ...
    <tr>
            ...
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#LicenseInitData'>LicenseInitData</a></code>
            </td>
        </tr></table>
...
<table>
    ...
    <tr>
            <td><code>result</code></td>
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#LicenseSession_GenerateLicenseRequest_Result'>LicenseSession_GenerateLicenseRequest_Result</a></code>
            </td>
        </tr></table>
...
### GenerateLicenseRelease {:#GenerateLicenseRelease}
 ...
 This will cause the <a class='link' href='../fuchsia.media.drm/index.html#LicenseSession'>LicenseSession</a> to generate a <a class='link' href='../fuchsia.media.drm/index.html#LicenseMessage'>LicenseMessage</a>
...
### ProcessLicenseResponse {:#ProcessLicenseResponse}
 ...
 Updates the <a class='link' href='../fuchsia.media.drm/index.html#LicenseSession'>LicenseSession</a> with a message from the license server.
...
<table>
    ...
    <tr>
            ...
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#LicenseServerMessage'>LicenseServerMessage</a></code>
            </td>
        </tr></table>
...
<table>
    ...
    <tr>
            <td><code>result</code></td>
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#LicenseSession_ProcessLicenseResponse_Result'>LicenseSession_ProcessLicenseResponse_Result</a></code>
            </td>
        </tr></table>
...
### CreateDecryptor {:#CreateDecryptor}
 ...
 keys maintained by this <a class='link' href='../fuchsia.media.drm/index.html#LicenseSession'>LicenseSession</a>.
...
### OnLicenseMessageGenerated {:#OnLicenseMessageGenerated}
 ...
 Provides a <a class='link' href='../fuchsia.media.drm/index.html#LicenseMessage'>LicenseMessage</a> that should be sent to the license server.
...
<table>
    ...
    <tr>
            ...
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#LicenseMessage'>LicenseMessage</a></code>
            </td>
        </tr></table>
...
### OnKeysChanged {:#OnKeysChanged}
 ...
 - response `key_info` a list of the <a class='link' href='../fuchsia.media/index.html'>fuchsia.media</a>/<a class='link' href='../fuchsia.media/index.html#KeyId'>KeyId</a>s and their related
   <a class='link' href='../fuchsia.media.drm/index.html#KeyStatus'>KeyStatus</a>es
...
<table>
    ...
    <tr>
            ...
            <td>
                <code>vector&lt;<a class='link' href='../fuchsia.media.drm/index.html#KeyInfo'>KeyInfo</a>&gt;</code>
            </td>
        </tr></table>
...
<table>
    ...
    <tr>
            ...
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#ProvisioningStatus'>ProvisioningStatus</a></code>
            </td>
        </tr></table>
...
<table>
    ...
    <tr>
            <td><code>result</code></td>
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#Provisioner_SetServerCertificate_Result'>Provisioner_SetServerCertificate_Result</a></code>
            </td>
        </tr></table>
...
### GenerateProvisioningRequest {:#GenerateProvisioningRequest}
 ...
 used to generate <a class='link' href='../fuchsia.media.drm/index.html#ProvisioningRequest'>ProvisioningRequest</a>s. This message must be routed
...
<table>
    ...
    <tr>
            <td><code>request</code></td>
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#ProvisioningRequest'>ProvisioningRequest</a></code>
            </td>
        </tr></table>

### ProcessProvisioningResponse {:#ProcessProvisioningResponse}

 Updates the <a class='link' href='../fuchsia.media.drm/index.html#Provisioner'>Provisioner</a> with a message from the provisioning server.
 ...
 + request `response` a <a class='link' href='../fuchsia.media.drm/index.html#ProvisioningResponse'>ProvisioningResponse</a> from the provisioning
...
<table>
    ...
    <tr>
            <td><code>response</code></td>
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#ProvisioningResponse'>ProvisioningResponse</a></code>
            </td>
        </tr></table>
...
<table>
    ...
    <tr>
            <td><code>result</code></td>
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#Provisioner_ProcessProvisioningResponse_Result'>Provisioner_ProcessProvisioningResponse_Result</a></code>
            </td>
        </tr></table>
...
### RemoveProvisioning {:#RemoveProvisioning}
 ...
 Any active <a class='link' href='../fuchsia.media.drm/index.html#ContentDecryptionModule'>ContentDecryptionModule</a>s on this service instance that
...
*Defined in [fuchsia.media.drm/services.fidl](https://fuchsia.googlesource.com/fuchsia/+/master/sdk/fidl/fuchsia.media.drm/services.fidl#19)*
 ...
 is defined by the <a class='link' href='../fuchsia.media.drm/index.html#W3C Encrypted Media Extensions'>W3C Encrypted Media Extensions</a>. It uses plain-text
 keys to decrypt the source.

 If the client closes the `ClearKey` channel, derived
 `ContentDecryptionModule`s will remain active.

 <a class='link' href='../fuchsia.media.drm/index.html#W3C Encrypted Media Extensions'>W3C Encrypted Media Extensions</a>:
   https://www.w3.org/TR/encrypted-media

### CreateContentDecryptionModule {:#CreateContentDecryptionModule}

 Creates a new <a class='link' href='../fuchsia.media.drm/index.html#ContentDecryptionModule'>ContentDecryptionModule</a>.
...
<table>
    ...
    <tr>
            <td><code>cdm</code></td>
            <td>
                <code>request&lt;<a class='link' href='../fuchsia.media.drm/index.html#ContentDecryptionModule'>ContentDecryptionModule</a>&gt;</code>
            </td>
        </tr></table>
...
### CreateProvisioner {:#CreateProvisioner}
 ...
 Creates a new <a class='link' href='../fuchsia.media.drm/index.html#Provisioner'>Provisioner</a>.
...
<table>
    ...
    <tr>
            ...
            <td>
                <code>request&lt;<a class='link' href='../fuchsia.media.drm/index.html#Provisioner'>Provisioner</a>&gt;</code>
            </td>
        </tr></table>
...
*Defined in [fuchsia.media.drm/license_session.fidl](https://fuchsia.googlesource.com/fuchsia/+/master/sdk/fidl/fuchsia.media.drm/license_session.fidl#46)*
 ...
 A message originating from the <a class='link' href='../fuchsia.media.drm/index.html#LicenseSession'>LicenseSession</a> that the caller must route
...
<table>
    <tr><th>Name</th><th>Type</th><th>Description</th><th>Default</th></tr><tr>
            <td><code>type</code></td>
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#LicenseMessageType'>LicenseMessageType</a></code>
            </td>
            <td></td>
            <td>No default</td>
        </tr><tr>
...
*Defined in [fuchsia.media.drm/license_session.fidl](https://fuchsia.googlesource.com/fuchsia/+/master/sdk/fidl/fuchsia.media.drm/license_session.fidl#53)*
 ...
 to the <a class='link' href='../fuchsia.media.drm/index.html#LicenseSession'>LicenseSession</a> via `ProcessLicenseServerMessage`.
...
*Defined in [fuchsia.media.drm/provisioning.fidl](https://fuchsia.googlesource.com/fuchsia/+/master/sdk/fidl/fuchsia.media.drm/provisioning.fidl#16)*
 ...
 A message originating from the <a class='link' href='../fuchsia.media.drm/index.html#Provisioner'>Provisioner</a> that the caller must route to
...
<table>
    <tr><th>Name</th><th>Type</th><th>Description</th><th>Default</th></tr><tr>
            ...
            <td> An optional server to send the <a class='link' href='../fuchsia.media.drm/index.html#ProvisioningRequest'>ProvisioningRequest</a> to. This field is
...
*Defined in [fuchsia.media.drm/provisioning.fidl](https://fuchsia.googlesource.com/fuchsia/+/master/sdk/fidl/fuchsia.media.drm/provisioning.fidl#26)*
 ...
 provide to <a class='link' href='../fuchsia.media.drm/index.html#Provisioner.ProcessProvisioningResponse'>Provisioner.ProcessProvisioningResponse</a>.
...
*Defined in [fuchsia.media.drm/error.fidl](https://fuchsia.googlesource.com/fuchsia/+/master/sdk/fidl/fuchsia.media.drm/error.fidl#15)*
 ...
 originate from the <a class='link' href='../fuchsia.media.drm/index.html#W3C Encrypted Media Extensions'>W3C Encrypted Media Extensions</a> specification to cover
...
<table>
    <tr><th>Name</th><th>Type</th><th>Description</th></tr><tr>
            <td><code>response</code></td>
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#ContentDecryptionModule_SetServerCertificate_Response'>ContentDecryptionModule_SetServerCertificate_Response</a></code>
            </td>
            <td></td>
        </tr><tr>
            <td><code>err</code></td>
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#Error'>Error</a></code>
            </td>
            <td></td>
        </tr></table>
...
<table>
    <tr><th>Name</th><th>Type</th><th>Description</th></tr><tr>
            <td><code>response</code></td>
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#LicenseSession_GenerateLicenseRequest_Response'>LicenseSession_GenerateLicenseRequest_Response</a></code>
            </td>
            <td></td>
        </tr><tr>
            <td><code>err</code></td>
...
<table>
    <tr><th>Name</th><th>Type</th><th>Description</th></tr><tr>
            <td><code>response</code></td>
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#LicenseSession_ProcessLicenseResponse_Response'>LicenseSession_ProcessLicenseResponse_Response</a></code>
            </td>
            <td></td>
        </tr><tr>
            <td><code>err</code></td>
...
<table>
    <tr><th>Name</th><th>Type</th><th>Description</th></tr><tr>
            <td><code>response</code></td>
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#Provisioner_SetServerCertificate_Response'>Provisioner_SetServerCertificate_Response</a></code>
            </td>
            <td></td>
        </tr><tr>
            <td><code>err</code></td>
...
<table>
    <tr><th>Name</th><th>Type</th><th>Description</th></tr><tr>
            <td><code>response</code></td>
            <td>
                <code><a class='link' href='../fuchsia.media.drm/index.html#Provisioner_ProcessProvisioningResponse_Response'>Provisioner_ProcessProvisioningResponse_Response</a></code>
            </td>
            <td></td>
        </tr><tr>
            <td><code>err</code></td>
