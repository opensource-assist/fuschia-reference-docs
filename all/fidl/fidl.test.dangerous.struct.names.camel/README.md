...
# fidl.test.dangerous.struct.names.camel
...
*Defined in [fidl.test.dangerous.struct.names.camel/fidl.test.dangerous.struct.names.camel.test.fidl](https://fuchsia.googlesource.com/fuchsia/+/master/garnet/tests/fidl-dangerous-identifiers/fidl/fidl.test.dangerous.struct.names.camel.test.fidl#7)*
