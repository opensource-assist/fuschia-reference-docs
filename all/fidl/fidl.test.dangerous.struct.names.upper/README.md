...
# fidl.test.dangerous.struct.names.upper
...
*Defined in [fidl.test.dangerous.struct.names.upper/fidl.test.dangerous.struct.names.upper.test.fidl](https://fuchsia.googlesource.com/fuchsia/+/master/garnet/tests/fidl-dangerous-identifiers/fidl/fidl.test.dangerous.struct.names.upper.test.fidl#7)*
