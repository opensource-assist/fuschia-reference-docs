...
# fidl.test.dangerous.struct.names.lower
...
*Defined in [fidl.test.dangerous.struct.names.lower/fidl.test.dangerous.struct.names.lower.test.fidl](https://fuchsia.googlesource.com/fuchsia/+/master/garnet/tests/fidl-dangerous-identifiers/fidl/fidl.test.dangerous.struct.names.lower.test.fidl#7)*
